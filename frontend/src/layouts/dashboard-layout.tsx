...
export function DashboardLayout({ children }: Props) {
  ...
  return (
    <div className="h-[100dvh] bg-gray-900 text-green-400 font-mono flex flex-col">
      <TitleBar onMenuToggle={() => setIsDrawerOpen((v) => !v)} isDrawerOpen={isDrawerOpen} />
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <FileExplorer isOpen={isDrawerOpen} />
        {isDrawerOpen && (
          <div
