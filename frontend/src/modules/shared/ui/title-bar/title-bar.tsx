...
export const TitleBar = () => {
  ...
  return (
    <div className="h-10 bg-gray-900 border-b border-gray-700 flex items-center px-3 gap-3 shrink-0">
        ...
        {activeNote && (
          <>
            ...
            <button
              ...
              className="text-gray-300 font-mono text-sm hover:text-green-400 truncate max-w-48"
            >
              {activeNote.title}
            </button>
          </>
      ...
      <div className="flex items-center border border-gray-600 rounded-sm overflow-hidden shrink-0">
        <button
